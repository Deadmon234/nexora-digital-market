...
export default function SellerOrdersPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-slate-900">Commandes reçues</h1>
        ...
        <ul className="space-y-3">
          {orders.map((order) => (
            <li key={order.id}>
              ...
              >
                <div>
                  <p className="font-medium text-slate-900">Commande #{order.id}</p>
                  <p className="text-sm text-slate-500">{order.itemCount} article(s)</p>
                </div>
